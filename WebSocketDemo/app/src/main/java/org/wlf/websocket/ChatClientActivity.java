...
public class ChatClientActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServerInfo[] serverInfos = {new ServerInfo("连接Java Web后台", "ws://101.132.71" + "" +
                ".111:8887/JSR356-WebSocket/websocket/"), new ServerInfo("连接Java Appl+ication后台", "ws://101.132.71" + "" +
                ".111:8887")};// 所有连接后台
